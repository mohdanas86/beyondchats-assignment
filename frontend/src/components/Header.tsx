            ...
            <div className="max-w-7xl flex flex-wrap items-center justify-between mx-auto p-4">
                ...
                <div className="hidden w-full md:block md:w-auto" id="navbar-default">
                    <ul className="font-medium flex flex-col p-4 md:p-0 mt-4 border border-gray-200 rounded bg-gray-100 md:flex-row md:space-x-8 rtl:space-x-reverse md:mt-0 md:border-0 md:bg-slate-900">
                        <li>
                            <Link to="/original" className="block py-2 px-3 text-white bg-blue-600 rounded md:bg-transparent md:text-blue-600 md:p-0" aria-current="page">Original</Link>
                        </li>
                        <li>
                            <Link to="/enhanced" className="block py-2 px-3 text-white rounded hover:bg-gray-200 md:hover:bg-transparent md:border-0 md:hover:text-blue-600 md:p-0 md:dark:hover:bg-transparent">Enhanced</Link>
                        </li>
                    </ul>
                </div>
            </div>
